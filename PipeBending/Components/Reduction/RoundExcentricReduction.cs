...
{
    class RoundExcentricReduction : Component
    {
        ...
        public RoundExcentricReduction() : this("", 6,4,5) { }
        public RoundExcentricReduction(string name) : this(name, 6, 4, 5) { }
        public RoundExcentricReduction(string name, double radius, double lessRadius, double length)
        {
            Radius = radius;
            Length = length;
