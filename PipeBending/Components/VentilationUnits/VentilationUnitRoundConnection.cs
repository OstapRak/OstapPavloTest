...
{
    class VentilationUnitRoundConnection : Component
    {
        ...
        public VentilationUnitRoundConnection() : this("", 3,16,15,15,1,2) { }
        public VentilationUnitRoundConnection(string name) : this(name, 3, 16, 15, 15, 1, 2) { }
        public VentilationUnitRoundConnection(string name, double radius, double length, double height, double width, double zipperLength, double coneLength)
        {
            Radius = radius;
            Length = length;
            Height = height;
            ...
            points.Add(new Point3D(ConeLength, Radius * Math.Sin(-Math.PI / 4), Radius * Math.Cos(-Math.PI / 4)));
