...
namespace WpfApplication1.Commponents
{
    class DShapeOutlet : Component
    {
        ...
        public DShapeOutlet() : this("", 5,2) { }
        public DShapeOutlet(string name) : this(name, 5,2) { }
        public DShapeOutlet(string name, double radius, double length)
        {
            Radius = radius;
            Length = length;
            Name = name;
