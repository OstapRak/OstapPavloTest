...
namespace WpfApplication1.Commponents
{
    class DShapeEndCap: Component
    {
        ...
        public DShapeEndCap() : this("", 5) { }
        public DShapeEndCap(string name) : this(name, 5) { }
        public DShapeEndCap(string name, double radius)
        {
            Radius = radius;
            ...
            Entities.Add(surf);
            circle = new Arc(Plane.XY, new Point3D(-COEF_FOR_BIGGER_RADIUS * Radius * Math.Cos(Math.Asin(1 / COEF_FOR_BIGGER_RADIUS)), 0, 0), COEF_FOR_BIGGER_RADIUS * Radius, Math.Asin(1 / COEF_FOR_BIGGER_RADIUS), -Math.Asin(1 / COEF_FOR_BIGGER_RADIUS));
