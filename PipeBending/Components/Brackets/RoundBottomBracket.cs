...
{
    class RoundBottomBracket : Component
    {
        ...
        public RoundBottomBracket() : this("", 4, 6) { }
        public RoundBottomBracket(string name) : this(name, 4, 6) { }
        public RoundBottomBracket(string name, double radius, double extRadius)
        {
            Radius = radius;
            ExtRadius = extRadius;
            Name = name;
